...
$arrays = [
    ...
    "ALTER TABLE `orders_list` ADD `token` varchar(100) NOT NULL AFTER `userid`, ADD `bobi` int(10) NOT NULL AFTER `notif`;",
    ...
    "ALTER TABLE `server_plans` ADD `bobi` int(10) DEFAULT 0 AFTER `date`;",
    ...
    "ALTER TABLE `server_plans` ADD `dest` VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL AFTER `bobi`, ADD `serverNames` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL AFTER `dest`;",
    ...
    "ALTER TABLE `orders_list` ADD `agent_bought` INT(1) NOT NULL DEFAULT '0' AFTER `bobi`;",
...
function updateBot(){
    global $arrays, $connection, $walletbobres, $nowPaymentKey, $zarinpalId;
    ...
    if(isset($nowPaymentKey) && isset($zarinpalId)){
        $paymentKeys = array();
        $paymentKeys['bankAccount'] = $walletbobres;
    ...
    if(file_exists(getcwd() . '/settings/messagebobres.json')) unlink('../settings/messagebobres.json');
}
?>
