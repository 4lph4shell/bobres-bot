...
$mainValues = [
    'banned' => '❌ | هی بهت گفتم دقت کن این رباته چیزی حالیش نیست گوش نکردی ، الان مسدود شدی 😑😂',
    ...
    'customer_custome_plan_name'=>'لطفا نام کانفیگ دلخواه خودت رو وارد کن (--دقت کن حروف انگلیسی کوچک و عدد در آخر وارد کنی مثال: strawberry99--)',
    ...
    'amount_decreased_from_your_wallet'=> "✅ مبلغ AMOUNT تومان (SBT=Tomn) از حساب شما کم شد",
    'amount_decreased_from_user_wallet'=>"✅ مبلغ AMOUNT تومان (SBT=Tomn) از کیف پول کاربر مورد نظر کم شد",
...
✅ بعد از اینکه پرداختت تایید شد مبلغ مورد نظر به کیف پولت اضافه میشه!",
    ...
    'reached_main_menu'=>"خب برگشتم عقب اگه کاری داری بگو که میخوام با سرویس هام یکی دیگه رو سوپرایز کنم 😉 | اگه درخواست سرویس مجموعه استرابری رو داری یکی از گزینه هارو انتخاب کن که کارتو انجام بدم

🚪 /start",
    'increase_wallet_request_message'=>"💳 درخواست ( افزایش موجودی )

💰مبلغ: PRICE تومان (SBT=Tomn)
...
",
    ...
    'buy_account_cart_to_cart'=>"♻️ عزیزم یه تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن تا یه کانفیگ توت فرنگی 🍓 خوشگل بهت بفرستم :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از اینکه پرداختت توسط تیم مالی تایید شد ( لینک سرور ) به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart'=>"♻️ عزیزم یه تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن تا یه کانفیگ توت فرنگی 🍓 خوشگل بهت بفرستم :
...
💰مبلغ پرداختی: PRICE تومان (SBT=Tomn)
✏️ نام سرویس: REMARK
...
",
    ...
    'invited_user_joined_message'=>"😍|تبریک میگم بلاخره یه نفر با لینک شما وارد ربات شد",
    ...
    'start_message'=>'سلام به ربات مجموعه استرابری سرور 🍓 خوش اومدی 🫡🌸
    
ما در کنار شماییم تا بدون هیچ محدویتی به شبکه جهانی متصل شوید و این برای ما افتخار بزرگیست ❤️

✅ کیفیت در ساخت انواع کانکشن ها برای انواع سیستم عامل و دیوایس ها

📡 برقراری امنیت در ارتباط شما با داده های رمزنگاری شده و تانل شده

☎️ پشتیبانی تا روز آخر بصورت 24 ساعته

🔻🔺🔻🔺🔻🔺🔻🔺🔻🔺🔻🔺🔻🔺🔻
در صورت بروز هرگونه مشکل از طریق تیکت ربات یا واحد پشتیبانی 24 ساعته درارتباط باشید.
🔺🔻🔺🔻🔺🔻🔺🔻🔺🔻🔺🔻🔺🔻🔺

⚠🚧  توجه: درحین انجام فرآیند خرید به کلیه نکات نوشتاری ربات دقت کامل کرده و حتماً تنظیمات گفته شده در مرحله آخر خرید را برای اتصال حتما انجام داده و بعد ، اقدام به خرید و واریز بفرمایید.

⚠🚧  برای ثبت درخواست پنل نمایندگی فروش لطفاً قبل از درخواست با اپراتور آنلاین هماهنگی های لازم انجام دهید.

➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖

🔗آدرس کانال تلگرامی مجموعه:
@strawberryvpn

➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖

💡آماده ای شروع کنیم!خب بزن رو استارت که وقتشه وارد دنیای اینترنت بدون محدودیت و فیلتر بشی🙌😊

🚪 /start',
    'new_member_joined'=>"📢 | .یه کسخل جدید عضو ربات استرابری 🍓 شد اگه میشه به این کسخله یه دست محکم بزنین جوری که خایه هاش به هم بچسبه🤣🙄 :

نام و نام خانوادگی: FULLNAME
نام کاربری: @USERNAME
آیدی عددی: USERID

به نظرم اگه شل کنی و خر و با دایی اشتباه نگیری یه پیام به این کسخل بفرست مثلا ( تبلیغی یا خوش آمد گویی ) 😍",
...
مقدار تخفیف AMOUNT تومان (SBT=Tomn)",
...
'request_agency_message'=>"درخواست نمایندگی فروش سرویس(پنل همکاری)
...
⁮⁮ ⁮⁮",
    ...
    'agency_request_declined'=>"🥺 درخواست شما برای نمایندگی رد گردید لطفاً با اپراتور آنلاین هماهنگی های لازمه را انجام دهید",
    ...
    'agent_setting_message' =>" 🧚🏻‍♀️  نماینده محترم استرابری وی پی ان:
...
سفارش و سرویس مدنظرت رو برا خرید از استرابری انتخاب کن: 😊',
...
دسته بندی حجمی بسته اختصاصی مورد نظرت رو انتخاب کن 🤭",
...
برای تایید خرید پلنی که سفارش دادی رو انتخاب کن و برو برای پرداختش 🤲 🕋", 
    'buy_custom_plan'=>'➕ پلن دلخواه تو بخر',
    'select_one_plan_to_edit'=>"یکی از پلن ها رو انتخاب کن تا برات ویرایشش کنم", 
    'enter_account_amount' => "♻️ تعداد اکانت درخواستی رو وارد کن حداکثر هربار ۵ عدد:
...
⚠️ | نکته: در صورت وارد کردن به مقدار بالا احتمالا اکانت ساخته نشود و پنل x-ui گیر کند",
    ...
    'buy_custom_subscription_detail'=>"〽️ نام پلن: PLAN-NAME
        ...
        DESCRIPTION
        ➖➖➖➖➖➖➖",
    "agents_list" => "🔍 لیست نمایندگان و همکاران استرابری سرور:
...
$buttonValues = [
    'bot_reports'=>"📉 آمار کلی ربات استرابری",
    ...
    'join_channel'=>" عضویت در کانال استرابری",
    'have_joined'=>"عضو شدم ✅",
    'gift_volume_day'=>"🎯 هدیه حجم و زمان",
    'test_account'=>"🎁 دریافت اکانت تست ",
    'invite_friends'=>"🏆 مجموعه سازی(توکن)",
    'my_info'=>"🧑‍💼 حساب کاربری",
    'my_subscriptions'=>'📱کاربری های خریداری شده',
    'buy_subscriptions'=>'🛒خرید کاربری جدید',
    'shared_existence'=>"❕ موجودی اشتراکی ",
    'individual_existence'=>"❗️ موجودی اختصاصی ",
    'application_links'=>'🧩برنامه های لازمه اتصال',
    'my_tickets'=>"📨 تیکت و پشتیبانی",
    'search_config'=>"🪫 جستجوی مشخصات کانفیگ استرابری",
    'delete_config'=>"❌ حذف کانفیگ",
    'pay_with_wallet' => "💰پرداخت با موجودی",
    'request_agency' =>"🧑‍💼درخواست نمایندگی (پنل همکاری)🧑‍💼",
    ...
    'sharj'=>"💰🍓 شارژ کیف پول و خرید توکن",
    "qr_config"=>"🔳 کیو آر کانفیگ",
    "qr_sub"=>"🔳 کیو آر ساب",
    'start_bot'=>" شروع ربات استرابری",
