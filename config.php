...
function getAgentKeys(){
    ...
    return json_encode(['inline_keyboard'=>[
        [['text'=>$boughtAccounts,'callback_data'=>"Alph4ir"],['text'=>$buttonValues['agent_bought_accounts'],'callback_data'=>"Alph4ir"]],
        [['text'=>$joinedDate,'callback_data'=>"Alph4ir"],['text'=>$buttonValues['agent_joined_date'],'callback_data'=>"Alph4ir"]],
        [['text'=>$agencyDate,'callback_data'=>"Alph4ir"],['text'=>$buttonValues['agent_agency_date'],'callback_data'=>"Alph4ir"]],
...
function getRejectedAgentList(){
    ...
    if($list->num_rows>0){
        $keys = array();
        $keys[] = [['text'=>"آزاد ساختن",'callback_data'=>"Alph4ir"],['text'=>"اسم کاربر",'callback_data'=>'Alph4ir'],['text'=>"آیدی عددی",'callback_data'=>"Alph4ir"]];
        while($row = $list->fetch_assoc()){
            ...
            $keys[] = [['text'=>"✅",'callback_data'=>"releaseRejectedAgent" . $userId],['text'=>$fullName,'callback_data'=>"Alph4ir"],['text'=>$userId,'callback_data'=>"Alph4ir"]];
        }
...
function getAgentDetails($userId){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>"(" . $todayIncome['count'] . ") " . number_format($todayIncome['total']),'callback_data'=>'Alph4ir'],
            ['text'=>"درآمد امروز",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>"(" . $yesterdayIncome['count'] . ") " . number_format($yesterdayIncome['total']),'callback_data'=>"Alph4ir"],
            ['text'=>"درآمد دیروز",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>"(" . $lastWeekIncome['count'] . ") " . number_format($lastWeekIncome['total']),'callback_data'=>"Alph4ir"],
            ['text'=>"درآمد یک هفته",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>"(" . $lastMonthIncome['count'] . ") " . number_format($lastMonthIncome['total']),'callback_data'=>"Alph4ir"],
            ['text'=>"درآمد یک ماه",'callback_data'=>"Alph4ir"]
            ],
...
function getAgentsList($offset = 0){
    ...
    $keys[] = [['text'=>"حذف",'callback_data'=>"Alph4ir"],['text'=>"درصد تخفیف",'callback_data'=>"Alph4ir"],['text'=>"تاریخ نمایندگی",'callback_data'=>"Alph4ir"],['text'=>"اسم نماینده",'callback_data'=>"Alph4ir"],['text'=>"آیدی عددی",'callback_data'=>"Alph4ir"]];
    if($agentList->num_rows > 0){
        while($row = $agentList->fetch_assoc()){
            ...
            $keys[] = [['text'=>"❌",'callback_data'=>"removeAgent" . $userId],['text'=>"⚙️",'callback_data'=>"agentPercentDetails" . $userId],['text'=>$joinedDate,'callback_data'=>"Alph4ir"],['text'=>$fullName,'callback_data'=>"agentDetails" . $userId],['text'=>$userId,'callback_data'=>"agentDetails" . $userId]];
        }
    }
...
function getAgentDiscounts($agentId){
    ...
    $keys[] = [['text'=>" ",'callback_data'=>"Alph4ir"],
    ['text'=>$normal . "%",'callback_data'=>"editAgentDiscountNormal" . $agentId . "_0"],
    ['text'=>"عمومی",'callback_data'=>"Alph4ir"]];            
    ...
    if($botState['agencyPlanDiscount']=="on"){
        foreach($discounts['plans'] as $planId=>$discount){
            ...
            ['text'=>$info['title'] . " " . $catInfo['title'],'callback_data'=>"Alph4ir"]];            
        }
    }else{
        foreach($discounts['servers'] as $serverId=>$discount){
            ...
            ['text'=>$info['title'],'callback_data'=>"Alph4ir"]];            
        }                
    }
...
function getServerConfigKeys($serverId,$offset = 0){
    ...
    return json_encode(['inline_keyboard'=>array_merge([
        [
            ['text'=>$panelUrl,'callback_data'=>"Alph4ir"],
            ],
        [
            ['text'=>$cname,'callback_data'=>"editServerName$id"],
            ['text'=>"❕نام سرور",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>$flagbobres,'callback_data'=>"editServerFlag$id"],
            ['text'=>"🚩 پرچم سرور",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>$remarkbobres,'callback_data'=>"editServerRemark$id"],
            ['text'=>"📣 ریمارک سرور",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>$serverType??" ",'callback_data'=>"changeServerType$id"],
            ['text'=>"نوعیت سرور",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>$ucount,'callback_data'=>"editServerMax$id"],
            ['text'=>"ظرفیت سرور",'callback_data'=>"Alph4ir"]
            ]
            ],
            ($serverConfig['type'] != "marzban"?[
        [
            ['text'=>$portType,'callback_data'=>"changePortType$id"],
            ['text'=>"نوعیت پورت",'callback_data'=>"Alph4ir"]
            ],
        [
            ['text'=>$sni,'callback_data'=>"editsServersni$id"],
            ['text'=>"sni",'callback_data'=>"Alph4ir"],
            ],
        [
            ['text'=>$headerType,'callback_data'=>"editsServerheader_type$id"],
            ['text'=>"header type",'callback_data'=>"Alph4ir"],
            ],
        [
            ['text'=>$requestHeader,'callback_data'=>"editsServerrequest_header$id"],
            ['text'=>"request header",'callback_data'=>"Alph4ir"],
            ],
        [
            ['text'=>$responseHeader,'callback_data'=>"editsServerresponse_header$id"],
            ['text'=>"response header",'callback_data'=>"Alph4ir"],
            ],
        [
            ['text'=>$security,'callback_data'=>"editsServersecurity$id"],
            ['text'=>"security",'callback_data'=>"Alph4ir"],
            ],
        (($serverConfig['type'] == "sanaei" || $serverConfig['type'] == "alireza")?
        [
            ['text'=>$reality,'callback_data'=>"changeRealityState$id"],
            ['text'=>"reality",'callback_data'=>"Alph4ir"],
            ]:[]),
        [
        ...
        [
            ['text'=>"✂️ حذف سرور",'callback_data'=>"bobresdeleteserver$id"],
            ],
...
function getServerListKeys($offset = 0){
    ...
    $keys = array();
    $keys[] = [['text'=>"وضعیت",'callback_data'=>"Alph4ir"],['text'=>"تنظیمات",'callback_data'=>"Alph4ir"],['text'=>"نوعیت",'callback_data'=>"Alph4ir"],['text'=>"سرور",'callback_data'=>"Alph4ir"]];
    if($cats->num_rows == 0){
        $keys[] = [['text'=>"سروری یافت نشد",'callback_data'=>"Alph4ir"]];
    }else {
        while($cty = $cats->fetch_assoc()){
            ...
            $keys[] = [['text'=>$state,'callback_data'=>'toggleServerState' . $id . "_" . $offset],['text'=>"⚙️",'callback_data'=>"showServerSettings" . $id . "_" . $offset],['text'=>$serverType??" ",'callback_data'=>"Alph4ir"],['text'=>$cname,'callback_data'=>"Alph4ir"]];
        } 
    }
...
function getCategoriesKeys($offset = 0){
    ...
    $keys = array();
    $keys[] = [['text'=>"حذف",'callback_data'=>"Alph4ir"],['text'=>"اسم دسته",'callback_data'=>"Alph4ir"]];
    if($cats->num_rows == 0){
        $keys[] = [['text'=>"دسته بندی یافت نشد",'callback_data'=>"Alph4ir"]];
    }else {
        while($cty = $cats->fetch_assoc()){
            $id = $cty['id'];
            $cname = $cty['title'];
            $keys[] = [['text'=>"❌",'callback_data'=>"bobrescategorydelete$id" . "_" . $offset],['text'=>$cname,'callback_data'=>"bobrescategoryedit$id" . "_" . $offset]];
        }
    }
...
function getBotSettingKeys(){
    ...
    $plandelkhahbobres = $botState['plandelkhahState']=="on"?$buttonValues['on']:$buttonValues['off'];
...
function getBotReportKeys(){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>$allUsers,'callback_data'=>'Alph4ir'],
            ['text'=>"تعداد کل کاربران",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$allOrders,'callback_data'=>'Alph4ir'],
            ['text'=>"کل محصولات خریداری شده",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$allServers,'callback_data'=>'Alph4ir'],
            ['text'=>"تعداد سرورها",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$allCategories,'callback_data'=>'Alph4ir'],
            ['text'=>"تعداد دسته ها",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$allPlans,'callback_data'=>'Alph4ir'],
            ['text'=>"تعداد پلن ها",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$totalRewards,'callback_data'=>'Alph4ir'],
            ['text'=>"درآمد کل",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$dayReward,'callback_data'=>'Alph4ir'],
            ['text'=>"درآمد امروز",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$weekReward,'callback_data'=>'Alph4ir'],
            ['text'=>"درآمد هفته",'callback_data'=>'Alph4ir']
            ],
        [
            ['text'=>$monthReward,'callback_data'=>'Alph4ir'],
            ['text'=>"درآمد ماه",'callback_data'=>'Alph4ir']
            ],
        [
...
function getAdminsKeys(){
    ...
    if($usersList->num_rows > 0){
        while($user = $usersList->fetch_assoc()){
            $keys[] = [['text'=>"❌",'callback_data'=>"delAdmin" . $user['userid']],['text'=>$user['name'], "callback_data"=>"Alph4ir"]];
        }
    }else{
        $keys[] = [['text'=>"لیست ادمین ها خالی است ❕",'callback_data'=>"Alph4ir"]];
    }
    ...
    if($userCount->num_rows > 0){
        ...
        return json_encode(['inline_keyboard'=>[
            [
                ...
                ['text'=>"یوزرنیم",'callback_data'=>"Alph4ir"]
                ],
            [
                ['text'=>$fullName??" ",'callback_data'=>"Alph4ir"],
                ['text'=>"نام",'callback_data'=>"Alph4ir"]
                ],
            [
                ['text'=>$boughtService??" ",'callback_data'=>"Alph4ir"],
                ['text'=>"سرویس ها",'callback_data'=>"Alph4ir"]
                ],
            [
                ['text'=>$totalBoughtPrice??" ",'callback_data'=>"Alph4ir"],
                ['text'=>"مبلغ خرید",'callback_data'=>"Alph4ir"]
                ],
            [
                ['text'=>$userWallet??" ",'callback_data'=>"Alph4ir"],
                ['text'=>"موجودی کیف پول",'callback_data'=>"Alph4ir"]
                ],
            [
...
function getDiscountCodeKeys(){
    ...
    $keys = array();
    if($list->num_rows > 0){
        $keys[] = [['text'=>'حذف','callback_data'=>"Alph4ir"],['text'=>"استفاده هر یوزر",'callback_data'=>"Alph4ir"],['text'=>"تاریخ ختم",'callback_data'=>"Alph4ir"],['text'=>"تعداد استفاده",'callback_data'=>"Alph4ir"],['text'=>"مقدار تخفیف",'callback_data'=>"Alph4ir"],['text'=>"کد تخفیف",'callback_data'=>"Alph4ir"]];
        while($row = $list->fetch_assoc()){
            ...
            $keys[] = [['text'=>'❌','callback_data'=>"delDiscount" . $rowId],['text'=>$canUse, 'callback_data'=>"Alph4ir"],['text'=>$date,'callback_data'=>"Alph4ir"],['text'=>$count,'callback_data'=>"Alph4ir"],['text'=>$amount,'callback_data'=>"Alph4ir"],['text'=>$hashId,'callback_data'=>'copyHash' . $hashId]];
        }
    }else{
        $keys[] = [['text'=>"کد تخفیفی یافت نشد",'callback_data'=>"Alph4ir"]];
    }
    ...
    if($buttons->num_rows > 0){
        while($row = $buttons->fetch_assoc()){
            ...
            $keys[] = [
                        ...
                        ['text'=>$title??" " ,'callback_data'=>"Alph4ir"]];
        }
    }else{
        $keys[] = [['text'=>"دکمه ای یافت نشد ❕",'callback_data'=>"Alph4ir"]];
    }
...
function getPlanDetailsKeys($planId){
    ...
    if($pdResult->num_rows == 0) return null;
        ...
        $stmt->bind_param("i", $id);
        $stmt->execute();
        $bobresplanaccnumber = $stmt->get_result()->num_rows;
        $stmt->close();
        ...
        $keyboard = [
            ...
            [['text'=>$name,'callback_data'=>"bobresplanname$id"],['text'=>"🔮 نام پلن",'callback_data'=>"Alph4ir"]],
            ($reality == "true"?[['text'=>$dest,'callback_data'=>"editDestName$id"],['text'=>"dest",'callback_data'=>"Alph4ir"]]:[]),
            ($reality == "true"?[['text'=>$serverName,'callback_data'=>"editServerNames$id"],['text'=>"serverNames",'callback_data'=>"Alph4ir"]]:[]),
            ($reality == "true"?[['text'=>$spiderX,'callback_data'=>"editSpiderX$id"],['text'=>"spiderX",'callback_data'=>"Alph4ir"]]:[]),
            ($reality == "true"?[['text'=>$flow,'callback_data'=>"editFlow$id"],['text'=>"flow",'callback_data'=>"Alph4ir"]]:[]),
            [['text'=>$bobresplanaccnumber,'callback_data'=>"Alph4ir"],['text'=>"🎗 تعداد اکانت های فروخته شده",'callback_data'=>"Alph4ir"]],
            ($pd['inbound_id'] != 0?[['text'=>"$acount",'callback_data'=>"bobresplanslimit$id"],['text'=>"🚪 تغییر ظرفیت کانفیگ",'callback_data'=>"Alph4ir"]]:[]),
            ($pd['inbound_id'] != 0?[['text'=>$pd['inbound_id'],'callback_data'=>"bobresplansinobundid$id"],['text'=>"🚪 سطر کانفیگ",'callback_data'=>"Alph4ir"]]:[]),
            [['text'=>"✏️ ویرایش توضیحات",'callback_data'=>"bobresplaneditdes$id"]],
            [['text'=>number_format($price) . " تومان",'callback_data'=>"bobresplanrial$id"],['text'=>"💰 قیمت پلن",'callback_data'=>"Alph4ir"]],
            [['text'=>"♻️ دریافت لیست اکانت ها",'callback_data'=>"bobresplanacclist$id"]],
            ($server_info['type'] == "marzban"?[['text'=>"انتخاب Host",'callback_data'=>"marzbanHostSettings" . $id]]:[]),
            [['text'=>"✂️ حذف",'callback_data'=>"bobresplandelete$id"]],
...
function getUserOrderDetailKeys($id, $offset = 0){
    ...
    if($order->num_rows==0){
        ...
        array_push($keyboard, $configKeys, [
    			    ['text' => $userId, 'callback_data' => "Alph4ir"],
                    ['text' => "آیدی کاربر", 'callback_data' => "Alph4ir"],
                ],
                [
    			    ['text' => $firstName, 'callback_data' => "Alph4ir"],
                    ['text' => "اسم کاربر", 'callback_data' => "Alph4ir"],
                ],
                [
    			    ['text' => $isAgentBought, 'callback_data' => "Alph4ir"],
                    ['text' => "خرید نماینده", 'callback_data' => "Alph4ir"],
                ],
                [
    			    ['text' => "$name", 'callback_data' => "Alph4ir"],
                    ['text' => $buttonValues['plan_name'], 'callback_data' => "Alph4ir"],
                ],
                [
    			    ['text' => "$date ", 'callback_data' => "Alph4ir"],
                    ['text' => $buttonValues['buy_date'], 'callback_data' => "Alph4ir"],
                ],
                [
    			    ['text' => "$expire_date ", 'callback_data' => "Alph4ir"],
                    ['text' => $buttonValues['expire_date'], 'callback_data' => "Alph4ir"],
                ],
                [
    			    ['text' => " $leftgb", 'callback_data' => "Alph4ir"],
                    ['text' => $buttonValues['volume_left'], 'callback_data' => "Alph4ir"],
    			],
                [
                    ['text' => $buttonValues['selected_protocol'], 'callback_data' => "Alph4ir"],
                ]);
        ...
        if($inbound_id == 0){
            if($protocol == 'trojan') {
                if($security == "xtls"){
                    array_push($keyboard, 
                        [
                            ['text' => $protocol == 'trojan' ? '☑️ trojan' : 'trojan', 'callback_data' => "Alph4ir"],
            ...
            array_push($keyboard, 
                [
                    ['text' => " $protocol ☑️", 'callback_data' => "Alph4ir"],
                ],
                [
                    ['text'=>($enable == true?$buttonValues['disable_config']:$buttonValues['enable_config']),'callback_data'=>"changeUserConfigState" . $order['id']],
                    ['text'=>$buttonValues['delete_config'],'callback_data'=>"delUserConfig" . $order['id']],
