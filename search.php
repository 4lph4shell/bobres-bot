...
if (isset($_REQUEST['id'])) {
    ...
    if (preg_match('/^vmess:\/\/(.*)/', $config_link, $match)) {
        ...
        !preg_match('/[a-f0-9]{8}\-[a-f0-9]{4}\-4[a-f0-9]{3}\-(8|9|a|b)[a-f0-9]{3}\-[a-f0-9]{12}/', $config_link)
        && !(preg_match('/^[a-zA-Z0-9]{5,15}/', $config_link))
    ) {
        form("کاربری یافت نشد و یا به اتمام رسیده است در صورت نیاز با پشتیبانی استرابری در ارتباط باشید.");
        exit();
    }
    ...
    if (!$found) {
        form("اطلاعات وارد شده اشتباه می باشد لطفا بعد از بررسی دوباره مجددا تلاش بفرمایید", $cancelKey);
    } else {
        showForm("configInfo");
    }
} else {
...
?>
    ...
    <head>
        <title><?php if ($type == "unknown") echo "جستجوی اطلاعات کانفیگ استرابری سرور";
                elseif ($type == "id") echo " نتیجه اطلاعات کانفیگ استرابری سرور";
                ?></title>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="subject" content="استرابری سرور">
        <meta name="copyright" content="استرابری سرور">
        <meta name="author" content="A747iR, 4lph4-ir@gmail.com">
        <meta name="designer" content="A747ir">
        <meta name="owner" content="Strawberry server">
    ...
    <body style="background: <?php if (!isset($state)) echo "#f7f0f5";
                                elseif ($state) echo "#f7f0f5";
                                elseif (!$state) echo "#FF5733"; ?>;">
        ...
        ?>
            <div class="container" style="">
                <form id="contact" class="contactw" style="border: #238636;">
                    <br>
                    ...
                    <div class="mainform">
                        ...
                        <div>
                            ...
                            <p style="font-size:16px"><?php if ($isMarzban) echo "حجم دانلود + آپلود";
                                                        else echo "حجم دانلود"; ?></p>
                            <div class="progress-bar" style="display:flex; background: radial-gradient(closest-side, #F9F9F9 79%, transparent 80% 100%),conic-gradient(<?php if ($download <= 50) echo "#04a777 ";
                                                                                                                                                                        elseif ($download <= 70 && $download > 50) echo "yellow ";
                                                                                                                                                                        elseif ($download > 70) echo "red ";
                                                                                                                                                                        echo $download . "%"; ?>, #e2eafc 0);">
                                <?php if ($isMarzban) echo $totalUsed . "%";
                                else echo $download . "%"; ?></div>
                        </div>
                        <?php if (!$isMarzban) { ?>
                            <div style="margin-right:50px;">
                                <svg style="margin-left: 6px" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="20" height="20">
                                ...
                                <div class="progress-bar" style="display:flex; background: radial-gradient(closest-side, #F9F9F9 79%, transparent 80% 100%),conic-gradient(<?php if ($upload <= 30) echo "#f48c06 ";
                                                                                                                                                                            elseif ($upload < 50 && $upload > 30) echo "yellow ";
                                                                                                                                                                            elseif ($upload >= 50) echo "#ed254e ";
                                                                                                                                                                            echo $upload . "%"; ?>, #e2eafc 0);">
                                    <?php echo $upload . "%"; ?></div>
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="mainform" style="margin-top:50px;">
                        ...
                        <div style="margin-left: 6px">
                            ...
                            <div class="progress-bar" style="display:flex; background: radial-gradient(closest-side, #F9F9F9 79%, transparent 80% 100%),conic-gradient(<?php if ($leftMb <= 30) echo "red ";
                                                                                                                                                                        elseif ($leftMb < 50 && $leftMb > 30) echo "yellow ";
                                                                                                                                                                        elseif ($leftMb >= 50) echo "#ed254e ";
                                                                                                                                                                        echo $leftMb . "%"; ?>, #e2eafc 0);">
                                <?php echo $leftMb . "%"; ?></div>
                        </div>
                        ...
                        <div style="margin-right:50px;">
                            ...
                            <div class="progress-bar" style="display:flex; background: radial-gradient(closest-side, #F9F9F9 79%, transparent 80% 100%),conic-gradient(<?php if ($upload <= 50) echo "#467599 ";
                                                                                                                                                                        elseif ($upload <= 70 && $upload > 50) echo "#467599 ";
                                                                                                                                                                        elseif ($upload > 70) echo "#467599 ";
                                                                                                                                                                        echo $upload . "%"; ?>, #467599 0);">
                    ...
                    <p style="font-size:13px">coding by StrawberryVPN™<a target="_blank" href="https://strawberryvps.com">StrawberryVPN™ WebSite</a></p>
                </form>
            </div>
    </body>
...
<?php } elseif ($type == "unknown") { ?>
    ...
    <head>
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1">
        <meta charset="UTF-8">
        <title>کانفیگ استرابری سرور</title>
        <style>
            body {
    ...
    <body>
        <div id="__next">
            <section class="ant-layout1 PayPing-layout1">
                <main>
                    <div class="justify-top align-top w-100">
                        <div class="container">
                            <form id="contact" action="search.php" method="get">
                                <h3>لطفا اطلاعات خواسته شده کانفیگ استرابری خود را وارد کنید</h3>
                                <fieldset style="margin-bottom: 20px;">
                                    <input
                                        placeholder="لینک اتصال (لینک دسترسی مستقیم) کانفیگ را وارد کنید"
                                        type="text"
                                        id="id"
                                        name="id"
                                        autocomplete="off"
                                ...
                                <fieldset style="margin-bottom: 20px;">
                                    <button type="submit" class="search">جستجو در استرابری سرور</button>
                                </fieldset>
                            </form>
                        </div>
                    </div>
        ...
        <footer>
            <div class="footer-container">
                <a href="https://strawberryvps.com/" target="_blank">| خانه استرابری سرور |</a>
                <a href="https://bot.strawberryvps.com/radar.php/" target="_blank">| رادار آنلاین شبکه استرابری سرور |</a>
                <a href="https://t.me/strawberry_server/" target="_blank">| باشگاه مشتریان استرابری سرور |</a>
                <a href="https://strawberryvps.com/contact/" target="_blank">| ارتباط با ما |</a>
            </div>
            <p>
                <a target="_blank" href="https://strawberryvps.com">StrawberryVPS™ WebSite</a>
            </p>
            <p style="color:white;">Thank you for visiting Strawberry Server! 🍓</p>
        </footer>
    <?php } ?>
    </body>
...
?>
    ...
    <head>
        ...
        <meta name="designer" content="A747ir">
        <meta name="owner" content="Strawberry server">
        <meta name="theme-color" content="#0d1117"> <!-- GitHub dark theme color -->
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1">
        <title>کاربری یافت نشد!</title>
        <link type="text/css" href="assets/webconf.css" rel="stylesheet" />
    ...
    <body>
        ...
        <footer>
            <div class="footer-container">
                <a href="https://bot.strawberryvps.com/io.php">| بازگشت به خانه جستجو |</a>
                <a href="https://bot.strawberryvps.com/radar.php/" target="_blank">| رادار آنلاین شبکه استرابری سرور |</a>
                <a href="https://t.me/strawberry_server/" target="_blank">| باشگاه مشتریان استرابری سرور |</a>
                <a href="https://strawberryvps.com/contact/" target="_blank">| ارتباط با ما |</a>
            </div>
            ...
            <p style="color:white; margin-top: 1rem;">Thank you for visiting Strawberry Server! 🍓</p>
        </footer>
    </body>
